...
export default function SuperAdminPanel({ metrics = [] }: { metrics?: DashboardMetric[] }) {
  return (
      ...
      <CardHeader className="bg-rose-500/5 border-b border-rose-500/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl font-bold tracking-tight text-white">Super Admin Panel</CardTitle>
              <p className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-0.5">Governance Intelligence</p>
            </div>
          </div>
          <Badge className="bg-rose-500/20 text-rose-400 border-rose-500/30 font-bold tracking-widest">L0 Governance</Badge>
        </div>
      </CardHeader>
