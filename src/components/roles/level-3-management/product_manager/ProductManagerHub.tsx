...
export default function ProductManagerHub({ metrics = [] }: { metrics?: DashboardMetric[] }) {
  return (
      ...
      <CardHeader className="bg-violet-500/5 border-b border-violet-500/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl font-bold tracking-tight text-white">Product Roadmap</CardTitle>
              <p className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-0.5">Product Intelligence</p>
            </div>
          </div>
          <Badge className="bg-violet-500/20 text-violet-400 border-violet-500/30 font-bold tracking-widest">L3 Manager</Badge>
        </div>
      </CardHeader>
