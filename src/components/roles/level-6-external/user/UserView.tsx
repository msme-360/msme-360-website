...
export default function UserView({ metrics = [] }: { metrics?: DashboardMetric[] }) {
  return (
      ...
      <CardHeader className="bg-primary/5 border-b border-primary/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl font-bold tracking-tight text-white">Stakeholder View</CardTitle>
