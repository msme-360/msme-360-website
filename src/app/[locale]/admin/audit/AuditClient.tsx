              ...
              <tbody className="divide-y divide-border/50">
                {initialLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-muted/30 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest ${log.status === 'success' ? 'bg-primary/10 text-primary border border-primary/20' :
