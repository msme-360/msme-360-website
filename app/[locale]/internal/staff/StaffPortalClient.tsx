...
export function StaffPortalClient({ profile, initialAnnouncements }: StaffPortalClientProps) {
  ...
  return (
    <AdminViewWrapper
      title={profile.role.replace('_', ' ').split(' ').map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ') + " Workspace"}
      subtitle="Internal coordination and productivity hub."
      badgeLabel="EXECUTION TIER"
      authorityLevel="L2-L3 Management"
    >
            ...
            <Card className="bg-primary/5 border-primary/20 overflow-hidden rounded-2xl">
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-primary uppercase tracking-wider">C-Suite Update</span>
                </div>
              </CardContent>
            </Card>
          </div>
