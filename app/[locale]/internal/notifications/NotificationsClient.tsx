          ...
          {notifications.length > 0 ? (
            notifications.map((notification) => (
              <motion.div
                ...
                className="relative"
              >
                <Card className={`glass-card border-white/5 transition-all duration-300 group ${
                  notification.is_read ? 'opacity-60 grayscale-[0.5]' : 'border-indigo-500/20 bg-indigo-500/5'
                }`}>
