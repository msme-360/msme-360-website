  ...
  return (
    <div className="space-y-10 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold tracking-tight">Board Control Center</h1>
          <p className="text-muted-foreground text-sm">Level 0 Governance overview and system integrity monitoring.</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest bg-white/5 px-2 py-1 rounded border border-white/10 group-hover:border-primary/50 transition-colors">Immutable Logs</div>
        </div>
      </div>
